...
class ChromeMediaGalleries extends ChromeApi {
  ...
  ChromeMediaGalleries._() {
    ...
    _onGalleryChanged = new ChromeStreamController<GalleryChangeDetails>.oneArg(
        getApi,
        'onGalleryChanged',
        _createGalleryChangeDetails);
    _onScanProgress = new ChromeStreamController<ScanProgressDetails>.oneArg(
        getApi,
        'onScanProgress',
        _createScanProgressDetails);
  }
  ...
  Future<List<FileSystem>>
      getMediaFileSystems([MediaFileSystemsDetails details]) {
    if (_mediaGalleries == null) _throwNotAvailable();

    var completer = new ChromeCompleter<List<FileSystem>>.oneArg(
        (e) => listify(e, _createDOMFileSystem));
    _mediaGalleries.callMethod(
        'getMediaFileSystems',
  ...
  Future<AddUserSelectedFolderResult> addUserSelectedFolder() {
    ...
    var completer = new ChromeCompleter<AddUserSelectedFolderResult>.twoArgs(
        AddUserSelectedFolderResult._create);
  ...
  MediaFileSystemMetadata
      getMediaFileSystemMetadata(FileSystem mediaFileSystem) {
    if (_mediaGalleries == null) _throwNotAvailable();

    return _createMediaFileSystemMetadata(
        _mediaGalleries.callMethod(
            'getMediaFileSystemMetadata',
            [jsify(mediaFileSystem)]));
  }
  ...
  Future<List<MediaFileSystemMetadata>> getAllMediaFileSystemMetadata() {
    ...
    var completer = new ChromeCompleter<List<MediaFileSystemMetadata>>.oneArg(
        (e) => listify(e, _createMediaFileSystemMetadata));
    _mediaGalleries.callMethod(
   ...
   */
  Future<MediaMetadata> getMetadata(Blob mediaFile,
      [MediaMetadataOptions options]) {
    if (_mediaGalleries == null) _throwNotAvailable();

    var completer =
        new ChromeCompleter<MediaMetadata>.oneArg(_createMediaMetadata);
    _mediaGalleries.callMethod(
        'getMetadata',
        [jsify(mediaFile), jsify(options), completer.callback]);
    return completer.future;
  }
...
class GalleryChangeType extends ChromeEnum {
  static const GalleryChangeType CONTENTS_CHANGED =
      const GalleryChangeType._('contents_changed');
  static const GalleryChangeType WATCH_DROPPED =
      const GalleryChangeType._('watch_dropped');

  static const List<GalleryChangeType> VALUES = const [
      CONTENTS_CHANGED,
      WATCH_DROPPED];
...
class GetMediaFileSystemsInteractivity extends ChromeEnum {
  static const GetMediaFileSystemsInteractivity NO =
      const GetMediaFileSystemsInteractivity._('no');
  static const GetMediaFileSystemsInteractivity YES =
      const GetMediaFileSystemsInteractivity._('yes');
  static const GetMediaFileSystemsInteractivity IF_NEEDED =
      const GetMediaFileSystemsInteractivity._('if_needed');

  static const List<GetMediaFileSystemsInteractivity> VALUES = const [
      NO,
      YES,
      IF_NEEDED];
...
class GetMetadataType extends ChromeEnum {
  ...
  static const GetMetadataType MIME_TYPE_AND_TAGS =
      const GetMetadataType._('mimeTypeAndTags');
  static const GetMetadataType MIME_TYPE_ONLY =
      const GetMetadataType._('mimeTypeOnly');

  static const List<GetMetadataType> VALUES = const [
      ALL,
      MIME_TYPE_AND_TAGS,
      MIME_TYPE_ONLY];
...
class ScanProgressType extends ChromeEnum {
  ...
  static const List<ScanProgressType> VALUES = const [
      START,
      CANCEL,
      FINISH,
      ERROR];
...
class MediaFileSystemsDetails extends ChromeObject {
  ...
  MediaFileSystemsDetails.fromProxy(JsObject jsProxy)
      : super.fromProxy(jsProxy);

  GetMediaFileSystemsInteractivity get interactive =>
      _createGetMediaFileSystemsInteractivity(jsProxy['interactive']);
  set interactive(GetMediaFileSystemsInteractivity value) => jsProxy['interactive'] =
      jsify(value);
}
...
class MediaMetadataOptions extends ChromeObject {
  ...
  GetMetadataType get metadataType =>
      _createGetMetadataType(jsProxy['metadataType']);
  set metadataType(GetMetadataType value) => jsProxy['metadataType'] =
      jsify(value);
}

class MediaFileSystemMetadata extends ChromeObject {
  MediaFileSystemMetadata({String name, String galleryId, String deviceId,
      bool isRemovable, bool isMediaDevice, bool isAvailable}) {
  ...
  MediaFileSystemMetadata.fromProxy(JsObject jsProxy)
      : super.fromProxy(jsProxy);
...
class ScanProgressDetails extends ChromeObject {
  ScanProgressDetails({ScanProgressType type, int galleryCount, int audioCount,
      int imageCount, int videoCount}) {
    if (type != null) this.type = type;
...
class MediaMetadata extends ChromeObject {
  MediaMetadata({String mimeType, int height, int width, num xResolution,
      num yResolution, num duration, int rotation, String cameraMake,
      String cameraModel, num exposureTimeSeconds, bool flashFired, num fNumber,
      num focalLengthMm, num isoEquivalent, String album, String artist,
      String comment, String copyright, int disc, String genre, String language,
      String title, int track, List<StreamInfo> rawTags,
    ...
    if (exposureTimeSeconds != null) this.exposureTimeSeconds =
        exposureTimeSeconds;
  ...
  set exposureTimeSeconds(num value) => jsProxy['exposureTimeSeconds'] =
      jsify(value);
  ...
  List<StreamInfo> get rawTags =>
      listify(jsProxy['rawTags'], _createStreamInfo);
  ...
  set attachedImages(List<dynamic> value) => jsProxy['attachedImages'] =
      jsify(value);
}
...
class AddUserSelectedFolderResult {
  static AddUserSelectedFolderResult _create(mediaFileSystems,
      selectedFileSystemName) {
    return new AddUserSelectedFolderResult._(
        listify(mediaFileSystems, _createDOMFileSystem),
        selectedFileSystemName);
  }
  ...
  AddUserSelectedFolderResult._(this.mediaFileSystems,
      this.selectedFileSystemName);
}

GalleryChangeDetails _createGalleryChangeDetails(JsObject jsProxy) =>
    jsProxy == null ? null : new GalleryChangeDetails.fromProxy(jsProxy);
ScanProgressDetails _createScanProgressDetails(JsObject jsProxy) =>
    jsProxy == null ? null : new ScanProgressDetails.fromProxy(jsProxy);
FileSystem _createDOMFileSystem(JsObject jsProxy) =>
    jsProxy == null ? null : new CrFileSystem.fromProxy(jsProxy);
MediaFileSystemMetadata _createMediaFileSystemMetadata(JsObject jsProxy) =>
    jsProxy == null ? null : new MediaFileSystemMetadata.fromProxy(jsProxy);
MediaMetadata _createMediaMetadata(JsObject jsProxy) =>
    jsProxy == null ? null : new MediaMetadata.fromProxy(jsProxy);
GalleryChangeType _createGalleryChangeType(String value) =>
    GalleryChangeType.VALUES.singleWhere((ChromeEnum e) => e.value == value);
GetMediaFileSystemsInteractivity
    _createGetMediaFileSystemsInteractivity(String value) =>
    GetMediaFileSystemsInteractivity.VALUES.singleWhere(
        (ChromeEnum e) => e.value == value);
GetMetadataType _createGetMetadataType(String value) =>
    GetMetadataType.VALUES.singleWhere((ChromeEnum e) => e.value == value);
ScanProgressType _createScanProgressType(String value) =>
    ScanProgressType.VALUES.singleWhere((ChromeEnum e) => e.value == value);
StreamInfo _createStreamInfo(JsObject jsProxy) =>
    jsProxy == null ? null : new StreamInfo.fromProxy(jsProxy);
