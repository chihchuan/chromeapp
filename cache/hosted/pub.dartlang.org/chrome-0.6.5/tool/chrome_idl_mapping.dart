...
IDLNamespaceDeclaration idlNamespaceDeclarationMapping(Option copyrightMaybe,
    List<String> documentation, Option attributeMaybe, _, List<String> name,
    List body, __) {
  ...
  return new IDLNamespaceDeclaration(
      nameDotNotation,
 ...
 */
IDLCallbackDeclaration idlCallbackDeclarationMapping(List<String> documentation,
    _, String name, __, List<IDLParameter> parameters, ___) =>
 ...
 */
IDLParameter idlParameterMapping(String name, IDLType type, bool isOptional,
    bool isCallback) {
 ...
 */
IDLType _idlAttributeTypeMapping(IDLAttributeDeclaration attribute, {isArray:
    false}) {
...
IDLParameter
    idlOptionalParameterAttributeRemapTypeMapping(IDLAttributeDeclaration attribute,
    _, IDLType type, name) {
...
IDLField idlFieldBasedTypeMapping(List<String> documentation,
    Option attributeMaybe, IDLType type, Option<String> optional, String name, _) =>
    new IDLField(
        name,
        type,
        isOptional: optional.isDefined,
        documentation: documentation,
        attribute: attributeMaybe.isDefined ? attributeMaybe.value : null);
...
IDLAttributeTypeEnum _resolveEnum(String name) {
  var attributeEnum =
      IDLAttributeTypeEnum.values.singleWhere((IDLAttributeTypeEnum e) {
    return e.type == name;
  });
 ...
 */
IDLAttribute idlAttributeAssignedMultiValueMapping(String name, _,
    List<int> values) =>
