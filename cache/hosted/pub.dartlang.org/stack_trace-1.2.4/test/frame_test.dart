...
void main() {
  group('.parseVM', () {
    ...
    test('parses a stack frame without column correctly', () {
      var frame = new Frame.parseVM(
          "#1      Foo._bar " "(file:///home/nweiz/code/stuff.dart:24)");
      expect(
          frame.uri,
          equals(Uri.parse("file:///home/nweiz/code/stuff.dart")));
    ...
    test('parses a stack frame without line or column correctly', () {
      var frame =
          new Frame.parseVM("#1      Foo._bar " "(file:///home/nweiz/code/stuff.dart)");
      expect(
          frame.uri,
          equals(Uri.parse("file:///home/nweiz/code/stuff.dart")));
    ...
    test('converts "<anonymous closure>" to "<fn>"', () {
      ...
      expect(
          parsedMember('<anonymous closure>.<anonymous closure>.bar'),
          equals('<fn>.<fn>.bar'));
    });

    test('converts "<<anonymous closure>_async_body>" to "<async>"', () {
      var frame =
          new Frame.parseVM('#0 Foo.<<anonymous closure>_async_body> (foo:0:0)');
    ...
    test('throws a FormatException for malformed frames', () {
      ...
      expect(
          () => new Frame.parseVM('#1      (dart:async/future.dart:10:15)'),
          throwsFormatException);
      expect(
          () => new Frame.parseVM('Foo (dart:async/future.dart:10:15)'),
          throwsFormatException);
    });
  });
  ...
  group('.parseV8', () {
    ...
    test('parses a stack frame with an absolute POSIX path correctly', () {
      var frame =
          new Frame.parseV8("    at VW.call\$0 " "(/path/to/stuff.dart.js:560:28)");
    ...
    test('parses a stack frame with an absolute Windows path correctly', () {
      var frame =
          new Frame.parseV8("    at VW.call\$0 " r"(C:\path\to\stuff.dart.js:560:28)");
    ...
    test('parses a stack frame with a Windows UNC path correctly', () {
      var frame = new Frame.parseV8(
          "    at VW.call\$0 " r"(\\mount\path\to\stuff.dart.js:560:28)");
      expect(
          frame.uri,
    ...
    test('parses a stack frame with a relative Windows path correctly', () {
      var frame =
          new Frame.parseV8("    at VW.call\$0 " r"(path\to\stuff.dart.js:560:28)");
      expect(frame.uri, equals(Uri.parse("path/to/stuff.dart.js")));
      expect(frame.line, equals(560));
      expect(frame.column, equals(28));
      expect(frame.member, equals('VW.call\$0'));
    ...
    test('parses an anonymous stack frame correctly', () {
      var frame =
          new Frame.parseV8("    at http://pub.dartlang.org/stuff.dart.js:560:28");
      expect(
          frame.uri,
          equals(Uri.parse("http://pub.dartlang.org/stuff.dart.js")));
      expect(frame.line, equals(560));
    ...
    test('parses an IE10 eval stack frame correctly', () {
      var frame = new Frame.parseV8(
          "    at eval (eval at Anonymous function "
              "(http://pub.dartlang.org/stuff.dart.js:560:28))");
      expect(
          frame.uri,
          equals(Uri.parse("http://pub.dartlang.org/stuff.dart.js")));
    ...
    test('converts "<anonymous>" to "<fn>"', () {
      ...
      expect(
          parsedMember('<anonymous>.<anonymous>.bar'),
          equals('<fn>.<fn>.bar'));
    });
    ...
    test('throws a FormatException for malformed frames', () {
      ...
      expect(
          () => new Frame.parseV8('    at Foo (dart:async/future.dart)'),
          throwsFormatException);
      expect(
          () => new Frame.parseV8('    at Foo (dart:async/future.dart:10)'),
          throwsFormatException);
      expect(
          () => new Frame.parseV8('    at (dart:async/future.dart:10:15)'),
          throwsFormatException);
      expect(
          () => new Frame.parseV8('Foo (dart:async/future.dart:10:15)'),
          throwsFormatException);
      expect(
          () => new Frame.parseV8('    at dart:async/future.dart'),
          throwsFormatException);
      expect(
          () => new Frame.parseV8('    at dart:async/future.dart:10'),
          throwsFormatException);
      expect(
          () => new Frame.parseV8('dart:async/future.dart:10:15'),
          throwsFormatException);
    });
  });
  ...
  group('.parseFirefox/.parseSafari', () {
    ...
    test('parses a stack frame with a Windows UNC path correctly', () {
      var frame =
          new Frame.parseFirefox(r".VW.call$0@\\mount\path\to\stuff.dart.js:560");
      expect(
          frame.uri,
          equals(Uri.parse("file://mount/path/to/stuff.dart.js")));
      expect(frame.line, equals(560));
    ...
    test('parses a nested anonymous stack frame correctly', () {
      var frame =
          new Frame.parseFirefox(".foo/<@http://pub.dartlang.org/stuff.dart.js:560");
      expect(
          frame.uri,
          equals(Uri.parse("http://pub.dartlang.org/stuff.dart.js")));
      expect(frame.line, equals(560));
    ...
    test('parses a named nested anonymous stack frame correctly', () {
      ...
      frame =
          new Frame.parseFirefox(".foo/.name@http://pub.dartlang.org/stuff.dart.js:560");
      expect(
          frame.uri,
          equals(Uri.parse("http://pub.dartlang.org/stuff.dart.js")));
      expect(frame.line, equals(560));
    ...
    test('parses a nested anonymous stack frame with parameters correctly', () {
      var frame = new Frame.parseFirefox(
          '.foo(12, "@)()/<")/.fn<@' 'http://pub.dartlang.org/stuff.dart.js:560');
      expect(
          frame.uri,
          equals(Uri.parse("http://pub.dartlang.org/stuff.dart.js")));
      expect(frame.line, equals(560));
    ...
    test(
        'parses a deeply-nested anonymous stack frame with parameters ' 'correctly',
        () {
      var frame = new Frame.parseFirefox(
    ...
    test('throws a FormatException for malformed frames', () {
      ...
      expect(
          () => new Frame.parseFirefox('.foo@dart:async/future.dart'),
          throwsFormatException);
      expect(
          () => new Frame.parseFirefox('.foo(@dart:async/future.dart:10'),
          throwsFormatException);
      expect(
          () => new Frame.parseFirefox('@dart:async/future.dart'),
          throwsFormatException);
    });

    test('parses a simple stack frame correctly', () {
      var frame =
          new Frame.parseFirefox("foo\$bar@http://dartlang.org/foo/bar.dart:10:11");
    ...
    test('parses a stack frame with no line correctly', () {
      var frame =
          new Frame.parseFirefox("foo\$bar@http://dartlang.org/foo/bar.dart::11");
      expect(frame.uri, equals(Uri.parse("http://dartlang.org/foo/bar.dart")));
      expect(frame.line, isNull);
      expect(frame.column, equals(11));
      expect(frame.member, equals('foo\$bar'));
    ...
    test('parses a stack frame with no column correctly', () {
      var frame =
          new Frame.parseFirefox("foo\$bar@http://dartlang.org/foo/bar.dart:10:");
      expect(frame.uri, equals(Uri.parse("http://dartlang.org/foo/bar.dart")));
      expect(frame.line, equals(10));
      expect(frame.column, isNull);
      expect(frame.member, equals('foo\$bar'));
  ...
  group('.parseFriendly', () {
    ...
    test('parses a stack frame with no line or column correctly', () {
      var frame =
          new Frame.parseFriendly("http://dartlang.org/foo/bar.dart  Foo.<fn>.bar");
      expect(frame.uri, equals(Uri.parse("http://dartlang.org/foo/bar.dart")));
      expect(frame.line, isNull);
      expect(frame.column, isNull);
      expect(frame.member, equals('Foo.<fn>.bar'));
    ...
    test('parses a stack frame with no line correctly', () {
      var frame =
          new Frame.parseFriendly("http://dartlang.org/foo/bar.dart 10  Foo.<fn>.bar");
      expect(frame.uri, equals(Uri.parse("http://dartlang.org/foo/bar.dart")));
      expect(frame.line, equals(10));
      expect(frame.column, isNull);
      expect(frame.member, equals('Foo.<fn>.bar'));
    ...
    test('throws a FormatException for malformed frames', () {
      ...
      expect(
          () => new Frame.parseFriendly('foo/bar.dart'),
          throwsFormatException);
      expect(
          () => new Frame.parseFriendly('foo/bar.dart 10:11'),
          throwsFormatException);
    });
  });
  ...
  group('.library', () {
    test('returns the URI string for non-file URIs', () {
      expect(
          new Frame.parseVM('#0 Foo (dart:async/future.dart:0:0)').library,
          equals('dart:async/future.dart'));
      expect(
          new Frame.parseVM(
              '#0 Foo ' '(http://dartlang.org/stuff/thing.dart:0:0)').library,
          equals('http://dartlang.org/stuff/thing.dart'));
    });

    test('returns the relative path for file URIs', () {
      expect(
          new Frame.parseVM('#0 Foo (foo/bar.dart:0:0)').library,
  ...
  group('.location', () {
    test(
        'returns the library and line/column numbers for non-core ' 'libraries',
        () {
      expect(
          new Frame.parseVM('#0 Foo ' '(http://dartlang.org/thing.dart:5:10)').location,
          equals('http://dartlang.org/thing.dart 5:10'));
      expect(
          new Frame.parseVM('#0 Foo (foo/bar.dart:1:2)').location,
  ...
  group('.package', () {
    test('returns null for non-package URIs', () {
      expect(
          new Frame.parseVM('#0 Foo (dart:async/future.dart:0:0)').package,
          isNull);
      expect(
          new Frame.parseVM(
              '#0 Foo ' '(http://dartlang.org/stuff/thing.dart:0:0)').package,
          isNull);
    });

    test('returns the package name for package: URIs', () {
      expect(
          new Frame.parseVM('#0 Foo (package:foo/foo.dart:0:0)').package,
          equals('foo'));
      expect(
          new Frame.parseVM('#0 Foo (package:foo/zap/bar.dart:0:0)').package,
          equals('foo'));
    });
  });
  ...
  group('.toString()', () {
    test(
        ...
        () {
      expect(
          new Frame.parseVM('#0 Foo (http://dartlang.org/thing.dart:5:10)').toString(),
    ...
    test('converts "<anonymous closure>" to "<fn>"', () {
      expect(
          new Frame.parseVM(
              '#0 Foo.<anonymous closure> ' '(dart:core/uri.dart:5:10)').toString(),
          equals('dart:core/uri.dart 5:10 in Foo.<fn>'));
    });

    test('prints a frame without a column correctly', () {
      expect(
          new Frame.parseVM('#0 Foo (dart:core/uri.dart:5)').toString(),
    ...
    test('prints relative paths as relative', () {
      ...
      expect(
          new Frame.parseFriendly('$relative 5:10  Foo').toString(),
