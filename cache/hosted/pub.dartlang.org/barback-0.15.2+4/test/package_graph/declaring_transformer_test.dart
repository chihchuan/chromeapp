...
main() {
  ...
  test("gets a declared output with a different path", () {
    initGraph(["app|foo.blub"], {
      "app": [[new DeclaringRewriteTransformer("blub", "blab")]]
    });
  ...
  test("gets a declared output with the same path", () {
    initGraph(["app|foo.blub"], {
      "app": [[new DeclaringRewriteTransformer("blub", "blub")]]
    });
    updateSources(["app|foo.blub"]);
  ...
  test("doesn't get a consumed asset", () {
    initGraph(["app|foo.blub"], {
      "app": [[new DeclaringRewriteTransformer("blub", "blab")..consumePrimary =
          true]]
    });
    updateSources(["app|foo.blub"]);
  ...
  test(
    ...
    var transformer =
        new DeclaringRewriteTransformer("blub", "blab")..consumePrimary = true;
    initGraph(["app|foo.blub", "app|foo.txt"], {
  ...
  group("with an error in declareOutputs", () {
    ...
    test(
        ...
        () {
      var transformer = new DeclaringBadTransformer(
          "app|out.txt",
          declareError: true,
          applyError: false)..consumePrimary = true;
      initGraph(["app|foo.txt"], {
        "app": [[transformer]]
      });
  ...
  test("can emit outputs it didn't declare", () {
    initGraph(["app|foo.txt"], {
      "app": [[new DeclareAssetsTransformer([], emitted: ["app|out.txt"])]]
    });
  ...
  test(
      "can overwrite the primary input even if it declared that it wouldn't",
      () {
    var transformer =
  ...
  test("can declare outputs it doesn't emit", () {
    initGraph(["app|foo.txt"], {
      "app": [[new DeclareAssetsTransformer(["app|out.txt"], emitted: [])]]
    });
