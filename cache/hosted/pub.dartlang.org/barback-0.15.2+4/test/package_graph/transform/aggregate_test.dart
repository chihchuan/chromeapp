...
main() {
  ...
  test("an aggregate transformer can read from multiple primary inputs", () {
    ...
    initGraph(sources, {
      "app": [[new AggregateManyToOneTransformer("txt", "out.txt")]]
    });
  ...
  test("an aggregate transformer isn't run if there are no primary inputs", () {
    ...
    initGraph(["app|foo.zip", "app|bar.zap"], {
      "app": [[transformer]]
    });
  ...
  test("an aggregate transformer is re-run if a primary input is added", () {
    initGraph(["app|foo.txt", "app|bar.txt", "app|baz.txt"], {
      "app": [[new AggregateManyToOneTransformer("txt", "out.txt")]]
    });
  ...
  test(
      "an aggregate transformer ceases to run if all primary inputs are " "removed",
      () {
    initGraph(["app|foo.txt", "app|bar.txt"], {
      "app": [[new AggregateManyToOneTransformer("txt", "out.txt")]]
    });
  ...
  test(
      "an aggregate transformer starts to run if new primary inputs are " "added",
      () {
    initGraph(["app|foo.txt", "app|bar.txt"], {
      "app": [[new AggregateManyToOneTransformer("txt", "out.txt")]]
    });
  ...
  group("pass-through", () {
    test(
        "an aggregate transformer passes through its primary inputs by " "default",
        () {
      initGraph(["app|foo.txt", "app|bar.txt"], {
        "app": [[new AggregateManyToOneTransformer("txt", "out.txt")]]
      });
    ...
    test("an aggregate transformer can overwrite its primary inputs", () {
      initGraph(["app|foo.txt", "app|bar.txt"], {
        "app": [[new AggregateManyToManyTransformer("txt")]]
      });
    ...
    test("an aggregate transformer passes through non-primary inputs", () {
      initGraph(["app|foo.jpg", "app|bar.png"], {
        "app": [[new AggregateManyToManyTransformer("txt")]]
      });
  ...
  group("apply() transform stream", () {
    test(
      ...
      initGraph(["app|foo.txt", "app|bar.a"], {
        "app": [
            [rewrite],
    ...
    test(
      ...
      initGraph(["app|foo.txt", "app|bar.in"], {
        "app": [
            [rewrite],
            [new AggregateManyToOneTransformer("txt", "out.txt")]]
      });
    ...
    test(
      ...
      initGraph(["app|foo.txt", "app|bar.txt", "app|baz.a"], {
        "app": [[rewrite], [aggregate]]
      });
