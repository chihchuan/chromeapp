...
main() {
  ...
  test(
      "applies the correct transform if an asset is modified during isPrimary",
      () {
  ...
  test(
      "aborts processing if the primary input is removed during processing",
      () {
    var transformer = new RewriteTransformer("txt", "out");
    initGraph(["app|foo.txt"], {
      "app": [[transformer]]
  ...
  test(
      "transforms an asset that goes from non-primary to primary " "during isPrimary",
      () {
  ...
  test(
    ...
    initGraph(["app|foo.txt", "app|foo.md"], {
  ...
  test("returns an asset even if an unrelated build is running", () {
    initGraph(["app|foo.in", "app|bar.in",], {
  ...
  test(
    ...
    initGraph({
      ...
      "app": [[rewrite], [new ManyToOneTransformer("txt")]]
    });
  ...
  test(
    ...
    initGraph({
      ...
      "app": [// We need to use CheckContentTransformer here so that
