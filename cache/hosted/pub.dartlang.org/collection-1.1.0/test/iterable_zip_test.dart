...
main() {
  test("Basic", () {
    expect(
        new IterableZip([[1, 2, 3], [4, 5, 6], [7, 8, 9]]),
        equals([[1, 4, 7], [2, 5, 8], [3, 6, 9]]));
  });

  test("Uneven length 1", () {
    expect(
        new IterableZip([[1, 2, 3, 99, 100], [4, 5, 6], [7, 8, 9]]),
        equals([[1, 4, 7], [2, 5, 8], [3, 6, 9]]));
  });

  test("Uneven length 2", () {
    expect(
        new IterableZip([[1, 2, 3], [4, 5, 6, 99, 100], [7, 8, 9]]),
        equals([[1, 4, 7], [2, 5, 8], [3, 6, 9]]));
  });

  test("Uneven length 3", () {
    expect(
        new IterableZip([[1, 2, 3], [4, 5, 6], [7, 8, 9, 99, 100]]),
        equals([[1, 4, 7], [2, 5, 8], [3, 6, 9]]));
  });

  test("Uneven length 3", () {
    expect(
        new IterableZip([[1, 2, 3, 98], [4, 5, 6], [7, 8, 9, 99, 100]]),
        equals([[1, 4, 7], [2, 5, 8], [3, 6, 9]]));
  });
  ...
  test("Not-lists", () {
    ...
    expect(new IterableZip(allIts), equals([[1, 4, 7], [2, 5, 8], [3, 6, 9]]));
  });

  test("Error 1", () {
    expect(
        () => new IterableZip([iterError([1, 2, 3], 2), [4, 5, 6], [7, 8, 9]]).toList(),
        throwsA(equals("BAD")));
  });

  test("Error 2", () {
    expect(
        () => new IterableZip([[1, 2, 3], iterError([4, 5, 6], 5), [7, 8, 9]]).toList(),
        throwsA(equals("BAD")));
  });

  test("Error 3", () {
    expect(
        () => new IterableZip([[1, 2, 3], [4, 5, 6], iterError([7, 8, 9], 8)]).toList(),
        throwsA(equals("BAD")));
  });

  test("Error at end", () {
    expect(
        () => new IterableZip([[1, 2, 3], iterError([4, 5, 6], 6), [7, 8, 9]]).toList(),
        throwsA(equals("BAD")));
  });
  ...
  test("Error before first end", () {
    expect(
        () =>
            new IterableZip([iterError([1, 2, 3, 4], 4), [4, 5, 6], [7, 8, 9]]).toList(),
        throwsA(equals("BAD")));
  });

  test("Error after first end", () {
    expect(
        new IterableZip([[1, 2, 3], [4, 5, 6], iterError([7, 8, 9, 10], 10)]),
        equals([[1, 4, 7], [2, 5, 8], [3, 6, 9]]));
  });
}
